...
import {PlusOutlined, LoadingOutlined, BankOutlined, HomeOutlined} from '@ant-design/icons'
        ...
        <Item label="Home Type">
          <Radio.Group>
            <Radio.Button value={ListingType.APARTMENT}>
              <BankOutlined style={{ color: iconColor }}><span>Apartment</span></BankOutlined>
            </Radio.Button>
            <Radio.Button value={ListingType.HOUSE}>
              <HomeOutlined style={{ color: iconColor }}><span>House</span></HomeOutlined>
            </Radio.Button>
          </Radio.Group>
        </Item>
